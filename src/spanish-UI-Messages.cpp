...
std::string addGameName = "Ingrese el nombre del juego: ";
std::string gameIDmessage = "Ingrese ID del juego: ";
std::string editGameConfirmation = "Desea modificar el juego: ";
